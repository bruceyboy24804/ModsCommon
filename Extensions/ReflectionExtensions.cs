namespace ModsCommon.Extensions {
    ...
    public static class ReflectionExtensions {
        ...
        /// <summary>
        /// Initializes the static logger used for error reporting in reflection operations.
        /// Call once during mod startup.
        /// </summary>
        /// <param name="log">The logger instance to use.</param>
        public static void Initialize(ILog log) => s_Log = log;
        ...
        /// <returns>Value of the member of the original object.</returns>
        ...
        public static object GetMemberValue(this object obj, string memberName) {
            ...
            if (memInf == null) {
                LogError(new System.Exception("memberName"), $"{nameof(ReflectionExtensions)} {nameof(GetMemberInfo)} Couldn't find member name! ");
            }
        ...
        public static bool TryInvokeMethod(this object obj, string methodName, out object result, params object[] parameters) {
            ...
            if (method == null) {
                LogError($"{nameof(ReflectionExtensions)} {nameof(TryInvokeMethod)} Failed to find method '{methodName}' on type '{obj.GetType().FullName}'");
                return false;
            }
        ...
        private static void LogError(System.Exception ex, string message) {
            if (s_Log != null) {
