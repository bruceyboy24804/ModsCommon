...
// Shared base set of vanilla component/theme/focus types.
// Each mod augments IVanillaComponents / IVanillaThemes (via declaration merging) and adds its
// own props/types locally for components it pulls in beyond this base. The index signatures keep
// those mod-specific lookups type-safe-enough without forcing them into the shared lib.
