namespace ModsCommon.Rendering {
    using System;
    ...
    public partial class CustomOverlayRenderSystem : GameSystemBase {
        ...
        public struct Buffer {
            ...
            public void DrawLine(Color color, Line3.Segment line, float width, bool forceUpward = false) {
                ...
                DrawCurveImpl(color, color, 0f, 0, NetUtils.StraightCurve(line.a, line.b), width, num + width * 2f, 0f, default, num, forceUpward);
            }
            ...
            public void DrawDashedLine(Color color, Line3.Segment line, float width, float dashLength, float gapLength) {
                DrawCurveImpl(color, color, 0f, 0, NetUtils.StraightCurve(line.a, line.b), width, dashLength, gapLength, default, MathUtils.Length(line.xz));
            }

            public void DrawDashedLine(Color      outlineColor, Color         fillColor, float outlineWidth,
                                       StyleFlags styleFlags,   Line3.Segment line,      float width,
                                       float      dashLength,   float         gapLength) {
                DrawCurveImpl(outlineColor, fillColor, outlineWidth, styleFlags, NetUtils.StraightCurve(line.a, line.b), width, dashLength, gapLength, default, MathUtils.Length(line.xz));
            }

            public void DrawDashedLine(Color  color, Line3.Segment line, float width, float dashLength, float gapLength, float2 roundness) {
                DrawCurveImpl(color, color, 0f, 0, NetUtils.StraightCurve(line.a, line.b), width, dashLength, gapLength, roundness, MathUtils.Length(line.xz));
            }
            ...
            public void DrawCurve(Color      outlineColor, Color     fillColor, float outlineWidth,
                ...
                var num = MathUtils.Length(curve.xz);
                DrawCurveImpl(outlineColor, fillColor, outlineWidth, styleFlags, curve, width, num + width * 2f, 0f, default, num, forceUpward);
            }

            public void DrawCurve(Color color, Bezier4x3 curve, float width, float2 roundness, bool forceUpward = false) {
                var num = MathUtils.Length(curve.xz);
            ...
            public void DrawCurve(Color      outlineColor, Color     fillColor, float outlineWidth,
                ...
                var num = MathUtils.Length(curve.xz);
                DrawCurveImpl(outlineColor, fillColor, outlineWidth, styleFlags, curve, width, num + width * 2f, 0f, roundness, num, forceUpward);
            }

            public void DrawDashedCurve(Color color, Bezier4x3 curve, float width, float dashLength, float gapLength, bool forceUpward = false) {
                DrawCurveImpl(color, color, 0f, 0, curve, width, dashLength, gapLength, default, MathUtils.Length(curve.xz), forceUpward);
            }
            ...
            public void DrawDashedCurve(Color      outlineColor, Color     fillColor, float outlineWidth,
                ...
                DrawCurveImpl(outlineColor, fillColor, outlineWidth, styleFlags, curve, width, dashLength, gapLength, default, MathUtils.Length(curve.xz), forceUpward);
            }
